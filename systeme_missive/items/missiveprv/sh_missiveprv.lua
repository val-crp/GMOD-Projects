...
if SERVER then
	util.AddNetworkString("ixReadMissiveprv") -- Make sure the NetworkString is defined, else error
end
...
if CLIENT then
    ...
    local message = ""
    local sender = ""
    net.Receive("ixReadMissiveprv", function()
